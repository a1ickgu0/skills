...
1. Copy the example profile: `cp profiles/hpe-discover-networking.yaml profiles/my-event.yaml`
...
4. Validate: `validate_domain_analysis.py --profile profiles/my-event.yaml <analysis.md>`
